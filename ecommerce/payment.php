...
<input type="hidden" name="return" value="http://http://localhost/ecommerce/index.php"/>
<input type="hidden" name="cancel_return" value="http://http://localhost/ecommerce/index.php"/>
